...
class DetectorMessenger: public G4UImessenger
{
  ...
  private:
    ...
    G4UIcmdWithADoubleAndUnit* fGapLengthCmd;
    G4UIcmdWithADoubleAndUnit* fShieldLengthCmd;
    G4UIcmdWithADoubleAndUnit* fTargPressureCmd;
    G4UIcmdWithADoubleAndUnit* fGapPressureCmd;
